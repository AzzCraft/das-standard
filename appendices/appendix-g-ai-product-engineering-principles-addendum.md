...
**B5 — API semantics are part of the contract**
For any externally consumed endpoint/event:
...
- **SHOULD:** Prefer a minimal, local-first dependency set:
  - simulate or emulate third-party services
...
**I11 — Canonical entrypoints**
The harness SHOULD expose canonical commands (or equivalents):
...
- **SHOULD:** Maintain:
  ...
  2) A larger offline benchmark (slower, broader coverage)
...
**S6 — AI-specific security controls**
If you use LLMs, tools, retrieval, or agents:
